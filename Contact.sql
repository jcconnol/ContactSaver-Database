...
CREATE TABLE contact (
  ...
  userid character varying(32),  --Stored in the edu.uark.models.entities:ContactEntity#userid.
...
INSERT INTO contact (userid, phonenumber) VALUES ( --id is generated by default.
       'username1'
     , 8675301)
RETURNING id;

INSERT INTO contact (userid, phonenumber) VALUES (
       'username2'
     , 8675301)
RETURNING id;
